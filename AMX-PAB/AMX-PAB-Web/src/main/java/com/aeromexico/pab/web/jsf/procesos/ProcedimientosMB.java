 ...
 * @author Erick Diaz
 */
@Named(value = "procedimientosMB")
@SessionScoped
public class ProcedimientosMB implements Serializable {
    
    public ProcedimientosMB(){}
    ...
    public String returnMaster(){
		String	redirect=  "/portal/procesos/procedimientos?faces-redirect=true";
                findAll();
		return redirect;
    }
    ...
    public String addRow(){
		String	redirect=  "/portal/procesos/procedimientosDetalle?faces-redirect=true";
