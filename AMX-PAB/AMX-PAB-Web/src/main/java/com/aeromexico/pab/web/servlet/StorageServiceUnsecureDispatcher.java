 ...
 */
@WebServlet(name = "StorageServiceUnsecureDispatcher", urlPatterns = {"/_media/*"})
public class StorageServiceUnsecureDispatcher extends HttpServlet {
    private static Logger logger = LoggerFactory.getLogger(StorageServiceUnsecureDispatcher.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        path = request.getRequestURI().replace("_media", "media");
        ...
        try{
            ...
            logger.info(" storageServiceFacadeRemote: resourceLoaded2.length="+resourceLoaded2.length); 
            ...
            osResource.close();
            isReource.close();
            logger.info(" Dispatching: END Dispatching !");        
