 ...
 * @author Erick Diaz
 */
@Named(value = "guiasDeEntretenimientoMB")
@SessionScoped
public class GuiasDeEntretenimientoMB implements Serializable {
    
    public GuiasDeEntretenimientoMB(){}
    ...
    public String returnMaster(){
		String	redirect=  "/portal/procesos/guiasDeEntretenimiento?faces-redirect=true";
                findAll();
		return redirect;
    }
    ...
    public String addRow(){
		String	redirect=  "/portal/procesos/guiasDeEntretenimientoDetalle?faces-redirect=true";
