 ...
 * @author Erick Diaz
 */
@Named(value = "categoriasDeDocumentosMB")
@SessionScoped
public class CategoriasDeDocumentosMB implements Serializable{
    
    public CategoriasDeDocumentosMB(){}
    ...
    public String returnMaster(){
		String	redirect=  "/portal/publicaciones/categoriasDeDocumentos?faces-redirect=true";
                findAll();
		return redirect;
    }
    ...
    public String addRow(){
		String	redirect=  "/portal/publicaciones/categoriasDeDocumentosDetalle?faces-redirect=true";
