 ...
 * @author Erick Diaz
 */
@Named(value = "temasComunicadosMB")
@SessionScoped
public class TemasComunicadosMB implements Serializable{
    ...
    public String returnMaster(){
		String	redirect=  "/portal/publicaciones/temasDocumentos?faces-redirect=true";
                findAll();
		return redirect;
    }
    ...
    public String addRow(){
		String	redirect=  "/portal/publicaciones/temasDocumentosDetalle?faces-redirect=true";
