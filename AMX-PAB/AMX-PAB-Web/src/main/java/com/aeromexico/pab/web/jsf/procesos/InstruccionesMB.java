 ...
 * @author Erick Diaz
 */
@Named(value = "instruccionesMB")
@SessionScoped
public class InstruccionesMB implements Serializable {
    
    public InstruccionesMB(){}
    ...
    public String returnMaster(){
		String	redirect=  "/portal/procesos/instrucciones?faces-redirect=true";
                findAll();
		return redirect;
    }
    ...
    public String addRow(){
		String	redirect=  "/portal/procesos/instruccionesDetalle?faces-redirect=true";
