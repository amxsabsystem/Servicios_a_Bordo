#!/bin/bash
java -Dfile.encoding=UTF-8 -cp  AMX-PAB-DBEngine.jar com.aeromexico.pab.devtasks.DropAllByForceTables org.apache.derby.jdbc.ClientDriver "jdbc:derby://localhost:1527/AMX_PAB_DB_DEV" AMX_PAB_DEV_USR AMX_PAB_DEV_PWD
